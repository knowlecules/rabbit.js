...
JobSocket.prototype.connect = function(queue, exchange, routingKey, callback) {
  ...
  if (exchange) {
    return ch.assertExchange(exchange, this.options.routing || 'fanout', {durable: self.options.durable || true, autoDelete: self.options.autoDelete})
        .then(function(ok) {
          return ch.assertQueue(queue, {durable: self.options.persistent});
        })
        .then(function(okQueue) {
